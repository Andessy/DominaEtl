...
exports.handler = (event,context,callback) => {
  ...
  setTimeout(function() {
   ...
   const response = new Promise((resolve, reject) => {
        ...
        const url = 'http://35.245.132.133/ipdialbox/api_reports.php?token=7b69645f6469737472697d2d3230323130373232313532313130&report=skill_detail&date_ini='+dateStart+'&date_end='+dateEnd;
        console.log( url);
             ...
             console.log("No responseAns")
               ...
               converter.json2csv(JSON.parse(dataString), (err, data) => {
                    if (err) {
                     ...
                     uploadObjectToS3Bucket("domina-data-historic", "ANS-"+dateEnd+".csv", data);
                     // Subir archivo ANS a S3
                     uploadObjectToS3Bucket("domina-data-ans", "LastDataANS.csv", data);
                     // Subir archivo con última fecha de guardado a S3

                     uploadObjectToS3Bucket("domina-data-ans", "lastdate.txt", dateEnd);
